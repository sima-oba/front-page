...
export class ControlledTrafficService extends CommonService<ControlledTraffic> {
    ...
    protected findAll(): any {
        const baseUrl = `${CommonService.BACKEND_URLBASE}/${this.getServerPath()}?practice_type=CONTROLLED_TRAFFIC_SYSTEM`;
