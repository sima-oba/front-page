...
export default class MapboxExportControl implements IControl {
    ...
    public onAdd(map: MapboxMap): HTMLElement {
        ...
        generateButton.addEventListener('click', () => {
            const pageSize: HTMLSelectElement = document.getElementById('mapbox-gl-export-page-size') as HTMLSelectElement;
            const pageOrientation: HTMLSelectElement = document.getElementById('mapbox-gl-export-page-orientaiton') as HTMLSelectElement;
            const formatType: HTMLSelectElement = document.getElementById('mapbox-gl-export-format-type') as HTMLSelectElement;
            const dpiType: HTMLSelectElement = document.getElementById('mapbox-gl-export-dpi-type') as HTMLSelectElement;
